...
public class MNIForestBiome extends Biome {
  ...
  public static WorldGenTree treeGen =
      new WorldGenTree(
          false, 5, Blocks.LOG.getStateFromMeta(0), Blocks.LEAVES.getStateFromMeta(0), false);
  public static WorldGenTree specialTreeGen =
      new WorldGenTree(
          false, 5, Blocks.LOG.getStateFromMeta(1), Blocks.LEAVES.getStateFromMeta(1), false);
